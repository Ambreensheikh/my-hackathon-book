...
const config: Config = {
  ...
  organizationName: 'Ambreensheikh', // Usually your GitHub org/user name.
  ...
  customFields: {
    apiUrl: process.env.REACT_APP_API_URL || 'https://web-production-a045fe.up.railway.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Ambreensheikh',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Ambreensheikh',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Ambreensheikh GitHub',
              href: 'https://github.com/Ambreensheikh',
            },
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/ambreen-sheikh-1502172b5/',
            },
          ],
        },
        {
